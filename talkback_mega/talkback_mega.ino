...
Adafruit_GPS<HardwareSerial> gps(&Serial3);
...
void sendTmMessage(void* tmMessagePtr, int sizeBytes) {
  ...
  Serial2.write((uint8_t*) (&preAmble),2);
  Serial2.write((uint8_t*) tmMessagePtr,sizeBytes);
...
void setup() {
  ...
  Serial.begin(57600); // used only for USB programming and debugging!
  Serial2.begin(57600); // used for xbee shield
